...
@st.cache_resource
def carrega_modelo():
    #https://drive.google.com/file/d/1BAzYOtcZcfnF-2YrPz4TukKVAUiRully/view?usp=drive_link
    url = 'https://drive.google.com/uc?id=1BAzYOtcZcfnF-2YrPz4TukKVAUiRully'
...
def previsao(interpreter, image):
    ...
    # Classes do modelo
    classes = ['terreno_erosao','terreno_represa', 'terreno_viavel']
